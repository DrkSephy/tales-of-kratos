	    ...
	    update: function(){
	   	...
	   	clicked: function() {
	        ...
	        if(ig.game.skillsCatalog['healthIncrease1'].active && ig.game.skillsCatalog['defense2'].active 
		        ...
		        if(!ig.game.skillsCatalog['healthIncrease4'].active && player.abilityPoints >= ig.game.skillsCatalog['healthIncrease4'].points){
		        	...
		        	player.abilityPoints -= ig.game.skillsCatalog['healthIncrease4'].points;
		        }
		    }
	    },
	});
