	    ...
	    update: function(){
	   	...
	   	clicked: function() {
	        ...
	        if(ig.game.skillsCatalog['healthIncrease1'].active){
		        if(!ig.game.skillsCatalog['attack4'].active && player.abilityPoints >= ig.game.skillsCatalog['attack4'].points){
		        	player.stats.str += ig.game.skillsCatalog['attack4'].increase;
		        	ig.game.skillsCatalog['attack4'].active = true;
		        	player.abilityPoints -= ig.game.skillsCatalog['attack4'].points;
		        }
		    }
	    },
	});
