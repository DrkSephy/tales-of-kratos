	    ...
	    update: function(){
	   	...
	   	clicked: function() {
	        ...
	        if(ig.game.skillsCatalog['healthIncrease1'].active && ig.game.skillsCatalog['attack4'].active){
		        if(!ig.game.skillsCatalog['defense3'].active && player.abilityPoints >= ig.game.skillsCatalog['defense3'].points){
		        	player.stats.def += ig.game.skillsCatalog['defense3'].increase;
		        	ig.game.skillsCatalog['defense3'].active = true;
		        	player.abilityPoints -= ig.game.skillsCatalog['defense3'].points;
		        }
		    }
	    },
	});
