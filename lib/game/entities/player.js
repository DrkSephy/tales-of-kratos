...
.defines(function(){
    EntityPlayer = ig.Entity.extend({
        ...
        */
        ...
        abilityPoints: 30, // How many ability points we have to allocate
        ...
        update: function(){
            ...
            ******************************/
            ...
            if(ig.input.state('left') && !ig.game.menuVisible && !this.attacking){
                ...
                if(ig.input.state('attack') && !this.attacking && ig.game.artesCatalog['lightningBlade'].active){
                    this.atkTimer.reset();
                    this.pos.x -= 30;
                    this.tp -= 5;
                ...
                ***************************/
                ...
                if(ig.input.state('attack2') && !this.attacking && ig.game.artesCatalog['sonicThrust'].active){
                    this.atkTimer.reset();
                    this.pos.x -= 30;
                    this.tp -= 5;
            ...
            ****************/
                ...
                *******/
                ...
                if(ig.input.state('attack3') && !this.attacking && ig.game.spellsCatalog['wind'].active){
                    this.atkTimer.reset();
                    if(this.atkTimer.delta() < 0){
                ...
                ***********/
                ...
                if(ig.input.state('attack4') && !this.attacking && ig.game.spellsCatalog['fireball'].active){
                    this.atkTimer.reset();
                    if(this.atkTimer.delta() < 0){
            ...
            ************/
            ...
            else if(ig.input.state('up') && !ig.game.menuVisible && !this.attacking && ig.game.artesCatalog['hellPyre'].active){
                // Stop the player
                this.accel.x = 0;
                if(ig.input.state('attack2') && !this.attacking){
                    this.atkTimer.reset();
            ...
            ******************/
                ...
                if(this.atkTimer.delta() > -0.5){
                    if(typeof ig.game.getEntityByName('bolt') === 'undefined'){
                        ig.game.spawnEntity(EntityLightning, this.pos.x + 80, this.pos.y - 20, {flip: !this.flip});
                        this.attacking = false;
                    }
                }
                else if(this.atkTimer.delta() > -0.7){
