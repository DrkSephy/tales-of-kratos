        ...
        */
        ...
        update: function(){
            ...
            *************/
            ...
            if(this.atkTimer.delta() > -1.3 && this.arte === 'demon_fang'){
                ...
                if(typeof ig.game.getEntityByName('bolt') === 'undefined'){
                        ig.game.spawnEntity(EntityLightning, this.pos.x + 80, this.pos.y - 40, {flip: !this.flip});
                        this.attacking = false;
                }
                this.attacking = false;
                this.arte = '';
            ...
            ******************/
                ...
                if(this.atkTimer.delta() > -0.5){
                    if(typeof ig.game.getEntityByName('bolt') === 'undefined'){
                        ig.game.spawnEntity(EntityLightning, this.pos.x + 80, this.pos.y, {flip: !this.flip});
                        this.attacking = false;
                    }
                }
                else if(this.atkTimer.delta() > -0.7){
