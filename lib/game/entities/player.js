...
.defines(function(){
    EntityPlayer = ig.Entity.extend({
        ...
        */
        ...
        animSheet: new ig.AnimationSheet('media/kratos-s.png', 140, 100), // Animation sheet
        size: {x: 100, y: 100}, // Size of collision bounding box
        ...
        init: function(x, y, settings){
            ...
            */ 
            ...
            this.addAnim('run', 0.10, [14, 15, 16, 17, 18, 19, 20, 21, 28, 29, 30, 31, 32, 33]);
