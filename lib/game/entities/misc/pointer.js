...
.defines(function(){
    EntityPointer = ig.Entity.extend({
        ...
        update: function() {
            ...
            if(this.isLeftClicking && (this.pos.x >= 246 && this.pos.x <= 260) && (this.pos.y >= 6 && this.pos.y <= 22)){
                ig.game.gameState = 'artesMenu';
                ig.game.menuVisible = true;
            }

            if(this.isLeftClicking && (this.pos.x >= 216 && this.pos.x <= 230) && (this.pos.y >= 6 && this.pos.y <= 22)){
