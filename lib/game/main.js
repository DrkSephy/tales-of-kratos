    ...
    MyGame = ig.Game.extend({
        ...
        draw: function(){
            ...
            if(this.gameState === 'artesMenu' && this.menuVisible){
                // Draw artes menu
                this.transScreen.draw(0, 0);

                // Draw first arte box
                this.artesBox.draw(32, 32);
                // Draw second arte box
                this.artesBox.draw(32, 80);
                // Draw third arte box
                this.artesBox.draw(32, 128);
                // Draw fourth arte box
                this.artesBox.draw(32, 176);
