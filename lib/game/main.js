...
.defines(function(){
    MyGame = ig.Game.extend({
        ...
        levelUp: function(entity){
            ...
            entity.stats.mag += (this.levelsCatalog[entity.stats.level].magIncrease) * 1.02 + this.generateRandomInt(100, 500);
            entity.stats.def += (this.levelsCatalog[entity.stats.level].defIncrease) * 1.05 + this.generateRandomInt(100, 700);
            entity.stats.spd += (this.levelsCatalog[entity.stats.level].spdIncrease) * 1.01 + this.generateRandomInt(10,100);
            entity.stats.maxHP += (this.levelsCatalog[entity.stats.level].hpIncrease) * 1.01 + this.generateRandomInt(10, 200); 
            entity.stats.maxTP += (this.levelsCatalog[entity.stats.level].tpIncrease) * 1.03 + this.generateRandomInt(10, 500);
            entity.stats.level++;
            return;
        },
