...
.defines(function(){
    ig.BaseGame = ig.Game.extend({
        ...
        init: function(){
            ...
            this.auxMusic.add('media/bgm/rise_above.*', 'map');
    ...
    ig.MyGame = ig.BaseGame.extend({
        ...
        /* Bind keys here, set up initial variables */
        init: function(){
            console.log("Second game class? Da fuck?");
            // console.log(ig.game.auxMusic);
            /* Set up camera plugin */
        ...
        */
        ...
        draw: function(){
            ...
            if(this.gameState === 'stats' && this.menuVisible){
                ...
                this.fontContent10.green.draw(player.stats.level, 81, 70, ig.Font.ALIGN.CENTER);
                this.fontContent10.red.draw('HP    ', 41, 90, ig.Font.ALIGN.CENTER);
                this.fontContent10.green.draw(player.health + ' / ' + player.stats.maxHP, 91, 90, ig.Font.ALIGN.CENTER);
                this.fontContent10.red.draw('TP    ', 41, 110, ig.Font.ALIGN.CENTER);
                this.fontContent10.green.draw(player.tp + ' / ' + player.stats.maxTP, 91, 110, ig.Font.ALIGN.CENTER);

                this.fontContent10.red.draw('STR: ', 41, 130, ig.Font.ALIGN.CENTER);
                this.fontContent10.green.draw(player.stats.str, 61, 130, ig.Font.ALIGN.CENTER);
                this.fontContent10.red.draw('MAG: ', 42, 150, ig.Font.ALIGN.CENTER);
                this.fontContent10.green.draw(player.stats.mag, 61, 150, ig.Font.ALIGN.CENTER);
                this.fontContent10.red.draw('DEF: ', 41, 170, ig.Font.ALIGN.CENTER);
                this.fontContent10.green.draw(player.stats.def, 61, 170, ig.Font.ALIGN.CENTER);
                this.fontContent10.red.draw('SPD: ', 41, 190, ig.Font.ALIGN.CENTER);
                this.fontContent10.green.draw(player.stats.spd, 61, 190, ig.Font.ALIGN.CENTER);
                this.fontContent10.red.draw('EXP: ', 100, 130, ig.Font.ALIGN.CENTER);
                this.fontContent10.green.draw(this.levelsCatalog[player.stats.level].expTotal, 120, 130, ig.Font.ALIGN.CENTER);
                this.fontContent10.red.draw('NEXT: ', 103, 150, ig.Font.ALIGN.CENTER);
                this.fontContent10.green.draw(this.levelsCatalog[player.stats.level].expToNext, 130, 150, ig.Font.ALIGN.CENTER);
    ...
    ig.GameOverScreen = ig.BaseGame.extend({
    ...
    ig.StartScreen = ig.BaseGame.extend({
        ...
        update: function(){
            ...
            if(this.pointer.isLeftClicking){
                ...
                if(this.pointer.pos.x >= 92 + ig.game.screen.x && this.pointer.pos.x <= 238 + ig.game.screen.x && this.pointer.pos.y >= 122 + ig.game.screen.y && this.pointer.pos.y <= 131 + ig.game.screen.y){
                    this.fadeIn();
        ...
        draw: function(){
            ...
            this.fontContent10.draw('Start Game', x, y, ig.Font.ALIGN.CENTER);
