        ...
        draw: function(){
            ...
            if(this.gameState === 'artesMenu' && this.menuVisible && this.gameState !== 'spellsMenu'){
                ...
                if(!this.spawnedArteBoxes){
                    ...
                    this.spawnEntity(EntityIncreaseDemonFang, ig.game.screen.x + 132, 185);
                    this.spawnEntity(EntityDecreaseDemonFang, ig.game.screen.x + 164, 185);
                ...
                this.fontContent10.draw('Level: ' + this.artesCatalog['demonFang'].level, 70, 185);
