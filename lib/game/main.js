        ...
        */
        ...
        draw: function(){
            ...
            if(this.gameState === 'stats' && this.menuVisible){
                ...
                this.fontContent10.draw(player.health + ' / ' + player.stats.maxHP, 200, 35, ig.Font.ALIGN.CENTER);
                this.fontContent10.draw('TP    ', 130, 50, ig.Font.ALIGN.CENTER);
                this.fontContent10.draw(player.tp + ' / ' + player.stats.maxTP, 200, 50, ig.Font.ALIGN.CENTER);
