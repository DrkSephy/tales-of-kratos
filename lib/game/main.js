...
.defines(function(){
    MyGame = ig.Game.extend({
        ...
        displayedSuperSonicThrustDescription: false, 
        ...
        init: function(){
            ...
            this.arteMenu = this.spawnEntity(EntityArteMenu, ig.system.width / 2, 8);
            this.spellMenu = this.spawnEntity(EntitySpellMenu, ig.system.width / 2 + 64, 8);
        },

        // Here we set up menu interactions, camera updates
        update: function() {
            this.parent();
            this.arteMenu.pos.x = ig.game.screen.x + 250;
            this.arteMenu.pos.y = 8;
            this.spellMenu.pos.x = ig.game.screen.x + 250 - 32
            this.spellMenu.pos.y = 8;
        ...
        draw: function(){
            ...
            if(this.gameState === 'spellsMenu' && this.menuVisible){
                var player = ig.game.getEntitiesByType('EntityPlayer')[0];
                ...
                if(!this.spawnedArteBoxes){
                    ...
                    this.spawnEntity(EntityIncreaseLightning, ig.game.screen.x + 132, 40);
                    this.spawnEntity(EntityDecreaseLightning, ig.game.screen.x + 164, 40);
                    this.spawnEntity(EntitySpellBoxB, ig.game.screen.x + 32, 80);
                    this.spawnEntity(EntityIncreaseWind, ig.game.screen.x + 132, 90);
                    this.spawnEntity(EntityDecreaseWind, ig.game.screen.x + 164, 90);
                    this.spawnEntity(EntitySpellBoxC, ig.game.screen.x + 32, 128);
                    this.spawnEntity(EntityIncreaseHeal, ig.game.screen.x + 132, 140);
                    this.spawnEntity(EntityDecreaseHeal, ig.game.screen.x + 164, 140);
                    this.spawnEntity(EntitySpellBoxD, ig.game.screen.x + 32, 176);
                    this.spawnEntity(EntityIncreaseFireball, ig.game.screen.x + 132, 185);
                    this.spawnEntity(EntityDecreaseFireball, ig.game.screen.x + 164, 185);
                    this.spawnedArteBoxes = true; 
                }

                this.fontContent10.draw('Level: ' + this.spellsCatalog['lightning'].level, 70, 40);
                this.fontContent10.draw('Level: ' + this.spellsCatalog['wind'].level, 70, 90);
                this.fontContent10.draw('Level: ' + this.spellsCatalog['heal'].level, 70, 140);
                this.fontContent10.draw('Level: ' + this.spellsCatalog['fireball'].level, 70, 185);
            ...
            if(this.gameState === 'artesMenu' && this.menuVisible){
                ...
                if(!this.spawnedArteBoxes){
                    ...
                    this.spawnEntity(EntityArteBoxB, ig.game.screen.x + 32, 80);
                    this.spawnEntity(EntityIncreaseHellPyre, ig.game.screen.x + 132, 90);
                    this.spawnEntity(EntityDecreaseHellPyre, ig.game.screen.x + 164, 90);
                    ...
                    this.spawnEntity(EntityArteBoxD, ig.game.screen.x + 32, 176);
                    this.spawnEntity(EntityIncreaseSuperSonicThrust, ig.game.screen.x + 132, 185);
                    this.spawnEntity(EntityDecreaseSuperSonicThrust, ig.game.screen.x + 164, 185);
                    this.spawnedArteBoxes = true; 
                }
                ...
                if(this.displayedSuperSonicThrustDescription){
                    this.lightningBladeDescription.draw(100, 75);
                    this.fontContent10.draw('Super Sonic Trust', 110, 90);
                    this.fontContent10.draw('TP: ' + this.artesCatalog['superSonicThrust'].tp, 250, 90);
                    this.fontContent10.draw('Send an enemy flying with a powerful\nthrust.', 110, 120);
                }
