...
.defines(function(){
    MyGame = ig.Game.extend({
        ...
        init: function(){
            ...
            console.log(this.levelCatalog[1])
        },
        ...
        */
        ...
        draw: function(){
            ...
            var player = ig.game.getEntitiesByType('EntityPlayer')[0];
            if(player.attacking){
                this.arteBanner.draw(50, 20);
                if(this.activeArte === 'lightningBlade'){
                    this.fontContent10.draw('Lightning Blade', 110, 30);
                }
                else if(this.activeArte === 'sonicThrust'){
                    this.fontContent10.draw('Sonic Thrust', 115, 30);
                }

                else if(this.activeArte === 'lightning'){
                    this.fontContent10.draw('Lightning', 120, 30);
                }

                else if(this.activeArte === 'heal'){
                    this.fontContent10.draw('Heal', 130, 30);
                }

                else if(this.activeArte === 'wind'){
                    this.fontContent10.draw('Wind', 130, 30);
                }

                else if(this.activeArte === 'demonFang'){
                    this.fontContent10.draw('Demon Fang', 115, 30);
                }

                else if(this.activeArte === 'hellPyre'){
                    this.fontContent10.draw('Hell Pyre', 120, 30);
                }
            }
