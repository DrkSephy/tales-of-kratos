    ...
    ig.hud = ig.Class.extend({
        ...
        number_health: function() {
            ...
            if(player.attacking && !this.menuVisible){
                ig.game.attackingAnimation.draw(20, 180);
            } 
            else if(!player.attacking && !this.menuVisible){
                ig.game.okayAnimation.draw(20, 180);
            }
            ...
            context.fillText ('HP: ' + player.health + '/' + player.stats.maxHP, 135, 385); //font used is the default canvas font
            context.setAlpha = 1;
            return null;
        },
        ...
        number_mana: function() {
            ...
            context.fillStyle = "rgb(255, 255, 255)";
            context.font = "13px Arial";
            context.fillText ('MP: ' + player.tp + '/' + player.stats.maxTP, 135, 425); //font used is the default canvas font
            context.setAlpha = 1;
            return null;
        },
        ...
        bar_mana: function() {
            ...
            context.fillStyle = color;
            context.setAlpha = 0.9;
            context.fillRect (115, 430, h-6, 8);
            context.setAlpha = 1;
            return null;
        },
