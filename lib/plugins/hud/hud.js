    ...
    ig.hud = ig.Class.extend({
        ...
        number_health: function() {
            ...
            if(player.attacking && !this.menuVisible){
                ig.game.attackingAnimation.draw(10, 185);
            } 
            else if(!player.attacking && !this.menuVisible){
                ig.game.okayAnimation.draw(10, 185);
            }
            ...
            context.fillText ('HP: ' + player.health + '/' + player.stats.maxHP, 120, 385); //font used is the default canvas font
            context.setAlpha = 1;
            return null;
        },
        ...
        number_mana: function() {
            ...
            context.fillStyle = "rgb(255, 255, 255)";
            context.font = "13px Arial";
            context.fillText ('MP: ' + player.stats.tp + '/' + player.stats.maxTP, 120, 425); //font used is the default canvas font
            context.setAlpha = 1;
            return null;
        },
